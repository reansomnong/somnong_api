...
class SqlModel extends Model
{
    ...
    public function gb_somnong_quote()
    {
        return  'quotes/';
    }

    public function gb_somnong_payment()
    {
        return  'payment/';
    }

    public function gb_pos_product_image()
    {
        return  'pos/product/';
    }
    ...
    public function gb_profile_id(Request $request)
    {
        $userinfo = Auth::user();
        return  $userinfo['profile_id'];
    }
    ...
    public function gb_user_branch(Request $request)
    {
        ...
        return  trim($user[0]->branch_code);
    }
    ...
    public function gb_msg_insert()
    {
        return  'Insert successfully.';
    }

    public function gb_msg_retrieved()
    {
        return  'Retrieved successfully.';
    }

    public function gb_msg_wrong()
    {
